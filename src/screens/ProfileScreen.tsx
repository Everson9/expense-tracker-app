        ...
        <View style={styles.themeGrid}>
          {THEMES.map(t => (
            ...
            >
              ...
              <Text style={[styles.themeName, theme.id === t.id && { color: theme.text }]}>{t.name}</Text>
            </TouchableOpacity>
          ))}
        </View>
      </View>
...
function makeStyles(th: AppTheme) {
  ...
  emojiBtnSelected: { backgroundColor: th.accent + '30', borderWidth: 2, borderColor: th.accent },
  emoji: { fontSize: 24 },
