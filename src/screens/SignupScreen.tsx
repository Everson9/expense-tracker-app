      ...
      >
        ...
        <View style={styles.form}>
          ...
          <View style={styles.inputWrapper}>
            ...
            {password.length > 0 && (
              <Text style={[styles.passwordStrength, { color: password.length >= 8 ? theme.accent : password.length >= 6 ? '#FFD93D' : theme.danger }]}>
          ...
          <View style={styles.inputWrapper}>
            ...
            {confirmPassword.length > 0 && (
              <Text style={[styles.passwordStrength, { color: confirmPassword === password ? theme.accent : theme.danger }]}>
